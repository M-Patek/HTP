...
&= S_{k-1}^{P_k P_{k+1}} \cdot G^{h_k P_{k+1}} \cdot G^{h_{k+1}}
\end{aligned}$$
...
$$\mathcal{A}_1 \oplus \mathcal{A}_2 = (P_1 P_2, \quad Q_1^{P_2} \cdot Q_2)$$
...
$$\begin{aligned}
Let \quad \mathcal{A}_{12} &= (P_1 P_2, Q_1^{P_2} Q_2) \\
...
$$\begin{aligned}
Let \quad \mathcal{A}_{23} &= (P_2 P_3, Q_2^{P_3} Q_3) \\
